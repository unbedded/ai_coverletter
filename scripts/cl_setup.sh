...
# Create mine cover letters command
if create_if_not_exists ".claude/commands/mine_cover_letters.md"; then
cat > .claude/commands/mine_cover_letters.md << 'EOF'
# Mine Cover Letters

Extract and consolidate qualifications from existing cover letters into unified skills database.

## Usage
```
mine_cover_letters <input_directory> [--output skills_qualifications.md]
```
Example: `mine_cover_letters cover_letters_old/`

## Input
Directory containing existing cover letters in markdown format

## Process
1. Read all markdown files in input directory
2. Extract concrete qualifications using pattern recognition:
   - Look for specific projects with technologies and outcomes
   - Identify quantifiable results and business impact
   - Find progression language ("from X to Y", "advanced", "scaled")
   - Capture technical specificity (exact tools, standards, methodologies)
3. Categorize qualifications by skill area
4. Deduplicate similar qualifications across multiple letters
5. Track source files for each qualification
6. Generate unified skills_qualifications.md database

## Extraction Patterns
Look for these proven patterns from existing letters:
- **Project descriptions**: "Advanced/Built/Led [project] from [start] to [end]"
- **Technology integration**: "Integrated [tech1], [tech2], and [tech3]"
- **Quantified outcomes**: "Reduced X from Y to Z", "Increased A by B%"
- **Scale indicators**: "50,000+ records", "6 vehicles", "20+ years"
- **Standards compliance**: "achieved [certification]", "passed [standard]"
- **Business impact**: Cost savings, performance improvements, timeline beats

## Output
- Unified `source_materials/skills_qualifications.md` 
- Source tracking for each qualification
- Categorized by technical skills, soft skills, industry experience
- Ready for cover letter generation workflow

## Quality Criteria
Each extracted qualification should include:
- ✅ Specific project/company context
- ✅ Concrete technologies used
- ✅ Quantifiable outcomes  
- ✅ Business/technical impact
- ✅ Timeframe or scale indicators
EOF
fi
...
echo "   - Claude Code commands: mine_cover_letters, parse_job, generate_cover_letter, analyze_fit"
...
echo "   1. claude mine_cover_letters cover_letters_old/  # Extract from existing letters"
echo "   2. Review and edit source_materials/skills_qualifications.md"
echo "   3. Fill out source_materials/resume.md and personal_info.md"
echo "   4. Test with: claude parse_job raw_jobs/example_swe_2025-08-30.md"
echo "   5. Test with: claude generate_cover_letter processed_jobs/example_swe_2025-08-30_std.md"
echo ""
echo "Ready to mine your existing cover letters and automate future ones! 🚀"